...
par(new = TRUE)
plot.ts(mc.chain.list[[5]][1:nsim1,1], ylim = range(mc.chain.list[[1]][,1], mc.chain.list[[5]][,1]), yaxt='n', xaxt='n', ylab = "", cex.lab=1.2, cex.axis=1.2, col = rgb(107, 174, 214, maxColorValue = 255))

plot.ts(mc.chain.list[[1]][1:nsim1,2], ylim = range(mc.chain.list[[1]][,2], mc.chain.list[[5]][,2]), ylab = expression(x[12]), cex.lab=1.2, cex.axis=1.2, col = rgb(8, 69, 148, maxColorValue = 255))
par(new = TRUE)
plot.ts(mc.chain.list[[5]][1:nsim1,2], ylim = range(mc.chain.list[[1]][,2], mc.chain.list[[5]][,2]), yaxt='n', xaxt='n', ylab = "", cex.lab=1.2, cex.axis=1.2, col = rgb(107, 174, 214, maxColorValue = 255))
