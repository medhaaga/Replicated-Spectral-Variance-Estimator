...
\begin{figure}[htbp]
\centering
   \includegraphics[width=.62\linewidth]{gaussian-TargetTrace.pdf}\\
\vspace{-.5cm}
    \includegraphics[width=.62\textwidth]{gaussian-acf_hist.pdf} 
...
% \begin{figure}[htbp]
% \centering
% \includegraphics[width=.6\textwidth]{gaussian-acf_hist.pdf} \\
% % \includegraphics[width=.6\textwidth]{gaussian-acf_1e4.pdf} 
...
\begin{figure}[htbp]
\centering
   \includegraphics[width=.60\linewidth]{var-acf_n1000.pdf}
     \includegraphics[width=.60\linewidth]{var-acf_n10000.pdf} 
...
\begin{figure}[htbp]
    \centering
      \includegraphics[width = 2.3in]{var-frob.pdf} 
      \includegraphics[width = 2.3in]{var-ess.pdf}         
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width = .70\textwidth]{boom-all_1_3_8.pdf}\\
    \includegraphics[width = .70\textwidth]{boom-all_1_10_7.pdf}    
...
\begin{figure}[htbp]
    \centering
      \includegraphics[width = .30\textwidth]{boom-ess_1_3_8_m5.pdf}
      \includegraphics[width = .30\textwidth]{boom-ess_1_10_7_m5.pdf}          
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width = .32\textwidth]{sensor-trace_loc1.pdf}
      \includegraphics[width = .32\textwidth]{sensor-acf_n5e3.pdf}
      \includegraphics[width = .32\textwidth]{sensor-acf_n5e4.pdf}    
...
\begin{figure}[htbp]
    \centering
      \includegraphics[width = .30\textwidth]{sensor-frob.pdf} 
      \includegraphics[width = .30\textwidth]{sensor-ess.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width = 0.7\textwidth]{poisson-trace_n50000.pdf}
    \caption{Change point: Trace plots for second (left) and third (right) component.}
    \label{fig:poisson-trace}
\end{figure}
\begin{figure}[htbp]
    \centering
      \includegraphics[width = .6\textwidth]{poisson-acf_n1000.pdf}  \\ \vspace{-.5cm}
      \includegraphics[width = .6\textwidth]{poisson-acf_n10000.pdf}      
...
\begin{figure}[htbp]
    \centering
      \includegraphics[width = .6\textwidth]{magnolia-acf_n100.pdf}\\ \vspace{-.5cm}
      \includegraphics[width = .6\textwidth]{magnolia-acf_n1000.pdf}
